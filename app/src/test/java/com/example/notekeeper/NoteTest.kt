...
class NoteTest {
    ...
    internal fun isNotesEquals_differentIds() {
        val note1 = Note(id = 1, title = "Note 1", content = "This is note 1", timestamp = TIMESTAMP1)
        val note2 = Note(id = 2, title = "Note 1", content = "This is note 1", timestamp = TIMESTAMP1)
    ...
    internal fun isNotesEquals_differentTimestamps() {
        val note1 = Note(id = 1, title = "Note 1", content = "This is note 1", timestamp = TIMESTAMP1)
        val note2 = Note(id = 1, title = "Note 1", content = "This is note 1", timestamp = TIMESTAMP2)
    ...
    internal fun isNotesEquals_differentTitles() {
        val note1 = Note(id = 1, title = "Note 1", content = "This is note 1", timestamp = TIMESTAMP1)
        val note2 = Note(id = 1, title = "Note 2", content = "This is note 1", timestamp = TIMESTAMP1)
